...
| D-7 | `UserRepository.isOnboardingCompleted`, `onboardingCompleted`, `completeOnboarding` | Флаг онбординга нигде не читается и не пишется. Ключ DataStore оставить: удалять ключ не нужно. |
